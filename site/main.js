...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function changeMessage() {
        gsap.to(centerTexts[currentMessageIndex], { opacity: 0, y: -50, duration: 1.5, onComplete: function() {
            ...
            gsap.to(centerTexts[currentMessageIndex], { opacity: 1, y: 0, duration: 1.5, delay: 0.2, onComplete: changeMessage });
